...
if (! function_exists('ippon_paging_nav' )) :
/**
    ...
    <div class="nav-links row">
      ...
      <div class="col-sm-6">
        <div class="nav-previous text-left">
          <?php next_posts_link('<i class="icon-left-open"></i> Articles précédents', 0); ?>
        </div>
      </div>
      <?php endif; ?>
      ...
      <div class="col-sm-6">
        <div class="nav-next text-right">
          <?php previous_posts_link('Articles suivants <i class="icon-right-open"></i>', 0); ?>
        </div>
      </div>
      <?php endif; ?>
...
if ( ! function_exists( 'ippon_post_nav' ) ) :
/**
...
if ( ! function_exists( 'ippon_meta_date' ) ) :
/**
 * Print HTML with meta date information for current post.
 *
 * @since Ippon 1.0
 *
 * @param boolean $echo (optional) Whether to echo the date. Default true.
 * @return string The HTML-formatted meta post date.
 */
function ippon_meta_date($echo = true) {
  ...
  $date = sprintf( '
    ...
    esc_html(sprintf($format_prefix, get_post_format_string(get_post_format()), get_the_date('Y')))
  );
